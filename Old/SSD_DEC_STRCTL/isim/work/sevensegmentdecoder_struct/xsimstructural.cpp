...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_sevensegmentdecoder_struct_structural(const char*);
        topvh = createWork_sevensegmentdecoder_struct_structural("SevenSegmentDecoder_Struct");
