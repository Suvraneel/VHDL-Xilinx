...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_sevensegmentdecoder_dataflow_src_dataflow(const char*);
        topvh = createWork_sevensegmentdecoder_dataflow_src_dataflow("SevenSegmentDecoder_dataflow_src");
