...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_sevensegmentdecoder_datafow_tb_testbench_arch(const char*);
        topvh = createWork_sevensegmentdecoder_datafow_tb_testbench_arch("SevenSegmentDecoder_datafow_tb");
